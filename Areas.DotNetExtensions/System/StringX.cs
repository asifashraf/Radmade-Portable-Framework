...
public static class StringX
{
    ...
    {
        var s = PluralizationService.CreateService(new System.Globalization.CultureInfo("en-us"));

        if (!s.IsPlural(word))
        {
            return s.Pluralize(word);
        }
        else
        {
            return word;
    ...
    public static string Singularize(this string word)
    {
        ...
        if (!s.IsSingular(word))
        {
            return s.Singularize(word);
        }
        else
        {
            return word;
